        ...
        <div class="panel panel-default" style="padding: 20px;">
            <ul class="nav nav-pills nav-justified">
              ...
              <li role="presentation" class="disabled"><a href="#">Confirmation</a></li>
                ...
                <div class="col-md-5">
                    <input class="form-control" type="text" placeholder="Father's Name" id="example-text-input">
                ...
                <div class="col-md-5">
                    <input class="form-control" type="text" placeholder="Mother's Name" id="example-text-input">
                    <div class="help-block with-errors"></div>
                </div>
                </div>
                <br/>
